...
# Small patch (from mhardy@tkdevvm) and html output added by Aaron Forster (jmeter@forstersfreehold.com)
#
# Fixes:
...
sub ChartStackedPct {
  ...
  print $INDEXFILE "<img src=\"ChartStackedPct.png\"/>\n";
}
#-------------------------------------------------------------------------------
sub ChartStackedBars {
  ...
  print $INDEXFILE "<img src=\"ChartStacked.png\"/>\n";
}
#-------------------------------------------------------------------------------
sub ChartLines {
  my ($label, $mode) = @_;
  ...
  #print "Adding html link\n" if $DEBUG;
  print $INDEXFILE '<img src="' . $filename . "\"/>\n";
